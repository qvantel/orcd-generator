...
import se.qvantel.generator.utils.property.BatchConfig
import utils.Logger

object CDRGenerator extends App with SparkConnection with Logger with BatchConfig {
  // Prepare batch
  ...
  while (totalBatches < nrOfMaximumBatches) {
